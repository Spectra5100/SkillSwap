...
├── detail-*.html        # Pages de détail (Figma, Python, HTML/CSS, JS, UI/UX)
├── profil.html          # Profil utilisateur
├── discussions.html     # Liste des conversations
...
**Auteur** : Adrien B. Adem Loukili.  - Epitech Lyon 2026 
